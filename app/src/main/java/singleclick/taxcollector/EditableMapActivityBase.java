...
public abstract class EditableMapActivityBase extends Activity {
    ...
    protected void createBaseLayer() {
        ...
        try {
       	 	MBTilesRasterDataSource mbLayerSrc = new MBTilesRasterDataSource(new EPSG3857(), 13, 19, Environment.getExternalStorageDirectory()+ File.separator+"pajak_data"+ File.separator+"imgpajak.mbtiles", false, this);
       	 	RasterLayer mbLayer = new RasterLayer(mbLayerSrc, 123);
    ...
    private void createUIButtons() {
        ...
        saveChangesBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
            	Toast.makeText(EditableMapActivityBase.this, "Clicked save button ", Toast.LENGTH_LONG).show();
                saveChanges();
            }
        });
    ...
    private void modifyElementProperties(final VectorElement selectedElement) {
        ...
        builder.setItems(itemList.toArray(items), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                input.setText(userData.get(key));
